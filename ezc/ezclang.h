...
#define BUILTIN_STACKGET "@"
#define BUILTIN_STACKSET "@="


#define IS_BUILTIN(c) (ISLIM(c, BUILTIN_ADD) || ISLIM(c, BUILTIN_SUB) || ISLIM(c, BUILTIN_COPY) || ISLIM(c, BUILTIN_NEG) || ISLIM(c, BUILTIN_MUL) || ISLIM(c, BUILTIN_DIV) || ISLIM(c, BUILTIN_POW) || ISLIM(c, BUILTIN_FLOOR) || ISLIM(c, BUILTIN_DICTGET) || ISLIM(c, BUILTIN_DICTSET) || ISLIM(c, BUILTIN_NULL) || ISLIM(c, BUILTIN_STACKGET) || ISLIM(c, BUILTIN_STACKSET) || ISLIM(c, BUILTIN_GT) || ISLIM(c, BUILTIN_LT))
